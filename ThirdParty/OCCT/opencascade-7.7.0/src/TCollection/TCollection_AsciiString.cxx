                                        ...
                                        const Standard_Character theWhat)
{
  ...
  {
    //throw Standard_OutOfRange ("TCollection_AsciiString::SetValue(): NULL terminator is passed");     // DI_MODIFICATION  Added the line below. Handling the case. Happens in FSD_CmpFile::ReadString(TCollection_AsciiString& buffer)
      mylength = theWhere;
  }
