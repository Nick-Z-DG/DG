...
::
if "%INSTALLDIR%" == "" set INSTALLDIR=C:\Projects\KernelCAD\ThirdParty\OCCT\tcltk-86-32


:: Where is the Tcl source directory?
:: You can set the TCLDIR environment variable to your Tcl HEAD checkout
if "%TCLDIR%" == "" set TCLDIR=C:\Projects\KernelCAD\ThirdParty\OCCT\tcltk-86-32\tcl8.6.10
