...
Standard_Boolean operator == (const TopLoc_Location& Other) const
{
  ...
  Standard_EXPORT   Standard_Boolean IsEqual2(const TopLoc_Location& Other, Standard_Boolean ignoreLocation)  const;	// DI_MODIFICATION Added the function. 27Nov2018
