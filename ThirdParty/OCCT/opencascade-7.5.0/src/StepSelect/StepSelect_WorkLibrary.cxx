...
//  Preparation
  ...
  //DI_MODIFICATION sout << " Step File Name : "<<ctx.FileName();
  StepData_StepWriter SW(stepmodel);
  //DI_MODIFICATION sout<<"("<<stepmodel->NbEntities()<<" ents) ";
...
//   (impressions de mise au point)
    /*DI_MODIFICATION sout << " .. FileMod." << numod << filemod->Label();
...
//  Envoi
  ...
  //DI_MODIFICATION sout<<" Write ";
  Standard_Boolean isGood = SW.Print(fout);                 
  //DI_MODIFICATION sout<<" Done"<<std::endl;
